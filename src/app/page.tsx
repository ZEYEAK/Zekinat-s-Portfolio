      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I&#39;m Zekinat, a Product Manager based in Lagos, Nigeria. I
            specialize in building digital products that solve real problems,
            with experience across fintech, agritech, and media platforms.
          </p>
